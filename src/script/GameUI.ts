...
export default class GameUI extends ui.test.TestSceneUI {
    ...
    onEnable(): void {
        ...
        //创建播放器
        this._player = new NodePlayer();
        this._player.setView("video");
        this._player.setBufferTime(500);
    }
    ...
    onTipClick(e: Laya.Event): void {
        ...
        //开始播放流
        this._player.start("http://flv.bdplay.nodemedia.cn/live/bbb.flv");
    }
